...
regex_collections_and_exes: List[CollectionAndExes[RegexExercise]] = [
    CollectionAndExes(
        ExerciseCollection(collectionId=1, toolId="regex", title="Zahlen und Fakten", authors=["bje40dc"], text="TODO"),
        {ex.exerciseId: ex for ex in regex_coll_1_exes}
    ),
    CollectionAndExes(
        ExerciseCollection(collectionId=2, toolId="regex", title="Informationsextraktion", authors=["bje40dc"], text="TODO"),
